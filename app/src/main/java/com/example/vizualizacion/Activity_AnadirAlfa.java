...
public class Activity_AnadirAlfa extends AppCompatActivity {
    ...
    double Precio;
    private static final String SERVER_URL = "https://slate-gray-cargoes.000webhostapp.com/Panaderia/GuardarImagenAlfa.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_anadir_alfa);
        ...
        VolleyMultipartRequest multipartRequest = new VolleyMultipartRequest(Request.Method.POST, SERVER_URL,
                new Response.Listener<NetworkResponse>() {
                    ...
                    public void onResponse(NetworkResponse response) {
                        ...
                        Toast.makeText(Activity_AnadirAlfa.this, "Imagen enviada correctamente", Toast.LENGTH_SHORT).show();
                        Log.d("imagen", result);
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(Activity_AnadirAlfa.this, "Error al enviar la imagen", Toast.LENGTH_SHORT).show();
    ...
    private void insertarPanEnServidor(final String name, final String descriptiom, final Double price, final Uri imagenUri, final String canti) {
        RequestQueue queue = Volley.newRequestQueue(this);
        String url = "https://slate-gray-cargoes.000webhostapp.com/Panaderia/AgregarAlfajor.php"; // Reemplaza con la URL de tu archivo PHP
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                // Manejar la respuesta del servidor
                Toast.makeText(Activity_AnadirAlfa.this, "Alfajor insertado correctamente", Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                // Manejar el fallo de la solicitud
                Toast.makeText(Activity_AnadirAlfa.this, "Error al insertar el Alfajor", Toast.LENGTH_SHORT).show();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("img", "https://slate-gray-cargoes.000webhostapp.com/Alfajores/"+imageName);
                return params;
            }
        };
