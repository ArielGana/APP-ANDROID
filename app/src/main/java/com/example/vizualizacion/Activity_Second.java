...
public class Activity_Second extends AppCompatActivity {
    ...
    private static final String URL1 = "https://slate-gray-cargoes.000webhostapp.com/Panaderia/TraerOrdenadosF.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabButton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Activity_Second.this, Activity_Second.class);
                startActivity(i);
        ...
        fabButton2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Activity_Second.this, Activity_Third.class);
                startActivity(i);
        ...
        fabButton3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Activity_Second.this, Activity_Fourth.class);
                startActivity(i);
        ...
        fabButton4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Activity_Second.this, Activity_Five.class);
                startActivity(i);
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            for (int i = 0; i < response.length(); i++) {
                                ...
                                LinearLayout rowLayout = new LinearLayout(Activity_Second.this);
                                ...
                                // Crea el botón
                                Button eliminarButton = new Button(Activity_Second.this);
    ...
    public void Enviar(String Nombre , String Apellido ,String Fecha ,String tokenid,String Pan,String Cantidad){
        ...
        if(!tokenid.isEmpty()){
            ...
            FCMsend.pushNotification(
                    Activity_Second.this,tokenid,title,message);
