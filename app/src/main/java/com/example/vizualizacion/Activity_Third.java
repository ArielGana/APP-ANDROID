...
public class Activity_Third extends AppCompatActivity {
    ...
    private static final String URL1 = "https://slate-gray-cargoes.000webhostapp.com/Panaderia/TraerOrdenadosC.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabButton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Activity_Third.this, Activity_Second.class);
                startActivity(i);
        ...
        fabButton2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Activity_Third.this, Activity_Third.class);
                startActivity(i);
        ...
        fabButton3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Activity_Third.this, Activity_Fourth.class);
                startActivity(i);
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            for (int i = 0; i < response.length(); i++) {
                                ...
                                LinearLayout rowLayout = new LinearLayout(Activity_Third.this);
                                ...
                                // Crea el botón
                                Button eliminarButton = new Button(Activity_Third.this);
                                eliminarButton.setText("Listo");
                                eliminarButton.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        // Crear un cuadro de diálogo
                                        AlertDialog.Builder builder = new AlertDialog.Builder(Activity_Third.this);
    ...
    private TextView createTextView(String text, int leftMargin, int topMargin, int rightMargin, int bottomMargin) {
        TextView textView = new TextView(Activity_Third.this);
    ...
    public void Enviar(String Nombre , String Apellido ,String Fecha ,String tokenid,String Pan,String Cantidad){
        ...
        if(!tokenid.isEmpty()){
            ...
            FCMsend.pushNotification(
                    Activity_Third.this,tokenid,title,message);
