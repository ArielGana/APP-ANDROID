...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String URL1 = "https://slate-gray-cargoes.000webhostapp.com/Panaderia/TraerProcesados.php";
    ...
    private FloatingActionButton fabMain,fabanadir;
    ...
    private FloatingActionButton fabButton5;
    private FloatingActionButton fabButton6;
    private FloatingActionButton fabButton7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabButton5 = findViewById(R.id.fabAñadirNovedades);
        fabButton6 = findViewById(R.id.fabAñadirPan);
        fabButton7 = findViewById(R.id.fabAñadirAlfa);
        ...
        fabButton5.setVisibility(View.INVISIBLE);

        fabButton6.setVisibility(View.INVISIBLE);
        fabButton7.setVisibility(View.INVISIBLE);
        ...
        fabButton3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(MainActivity.this, Activity_Fourth.class);
                startActivity(i);
        ...
        fabButton5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Lógica para el botón 2

                Intent i = new Intent(MainActivity.this, Activity_CambiarNew.class);
                startActivity(i);
        ...
        fabButton6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Lógica para el botón 2

                Intent i = new Intent(MainActivity.this, Activity_EliminarPan.class);
                startActivity(i);
        ...
        fabButton7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Lógica para el botón 2

                Intent i = new Intent(MainActivity.this, Activity_EliminarAlfa.class);
                startActivity(i);
    ...
    private void expandFabButtons2() {
        // Muestra los botones flotantes adicionales
        fabButton5.show();
        fabButton6.show();
        fabButton7.show();
    ...
    private void collapseFabButtons2() {
    ...
    public void Enviar(String Nombre , String Apellido ,String Fecha ,String tokenid,String Pan,String Cantidad){
        ...
        if(!tokenid.isEmpty()){
            ...
            FCMsend.pushNotification(
                    MainActivity.this,tokenid,title,message);
