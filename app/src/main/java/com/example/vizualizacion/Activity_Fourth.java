...
public class Activity_Fourth extends AppCompatActivity {
    ...
    private static final String URL1 = "https://slate-gray-cargoes.000webhostapp.com/Panaderia/TraerOrdenadosP.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabButton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Activity_Fourth.this, Activity_Second.class);
                startActivity(i);
        ...
        fabButton2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Activity_Fourth.this, Activity_Third.class);
                startActivity(i);
        ...
        fabButton3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Activity_Fourth.this, Activity_Fourth.class);
                startActivity(i);
        ...
        fabButton4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Activity_Fourth.this, Activity_Five.class);
                startActivity(i);
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            for (int i = 0; i < response.length(); i++) {
                                ...
                                LinearLayout rowLayout = new LinearLayout(Activity_Fourth.this);
                                ...
                                // Crea el botón
                                Button eliminarButton = new Button(Activity_Fourth.this);
                                eliminarButton.setText("Listo");
                                eliminarButton.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        // Crear un cuadro de diálogo
                                        AlertDialog.Builder builder = new AlertDialog.Builder(Activity_Fourth.this);
    ...
    private TextView createTextView(String text, int leftMargin, int topMargin, int rightMargin, int bottomMargin) {
        TextView textView = new TextView(Activity_Fourth.this);
    ...
    public void Enviar(String Nombre , String Apellido ,String Fecha ,String tokenid,String Pan,String Cantidad){
        ...
        if(!tokenid.isEmpty()){
            ...
            FCMsend.pushNotification(
                    Activity_Fourth.this,tokenid,title,message);
