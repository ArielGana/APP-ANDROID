...
public class Activity_EliminarPan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eliminar_pan);


        requestQueue = Volley.newRequestQueue(this);

        ScrollView scrollView = findViewById(R.id.scrollView2); // Obtener la referencia del ScrollView
        LinearLayout linearContainer = new LinearLayout(Activity_EliminarPan.this);
        ...
        Typeface typeface = ResourcesCompat.getFont(Activity_EliminarPan.this, R.font.description);
        TextView precioFinalTextView = new TextView(Activity_EliminarPan.this);
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            ...
                            LinearLayout orderContainer = new LinearLayout(Activity_EliminarPan.this);
                            ...
                            for (int i = 0; i < response.length(); i++) {
                                ...
                                LinearLayout textButtonLayout = new LinearLayout(Activity_EliminarPan.this);
                                textButtonLayout.setOrientation(LinearLayout.VERTICAL);
                                textButtonLayout.setGravity(Gravity.CENTER_HORIZONTAL);


                                LinearLayout orderLayout = new LinearLayout(Activity_EliminarPan.this);
                                ...
                                ImageView imageView = new ImageView(Activity_EliminarPan.this);
                                ...
                                Space space1 = new Space(Activity_EliminarPan.this);
                                ...
                                // Crea  boton Añadir
                                Button VerButton = new Button(Activity_EliminarPan.this);
                                ...
                                VerButton.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        AlertDialog.Builder builder = new AlertDialog.Builder(Activity_EliminarPan.this);
                                        builder.setTitle("Confirmar eliminación");
                                        builder.setMessage("¿Estás seguro de que quieres eliminar este pan?");
                                ...
                                Space space3 = new Space(Activity_EliminarPan.this);
                                ...
                                Space space2 = new Space(Activity_EliminarPan.this);
                                ...
                                Typeface typeface = ResourcesCompat.getFont(Activity_EliminarPan.this, R.font.description);
                                TextView textView = new TextView(Activity_EliminarPan.this);
    ...
    public void eliminarPan(String id) {
        String url = "https://slate-gray-cargoes.000webhostapp.com/Panaderia/EliminarPan.php";
    ...
    public void AñadirPan(View a){

        Intent i = new Intent(Activity_EliminarPan.this, Activity_AnadirPan.class);
        startActivity(i);
